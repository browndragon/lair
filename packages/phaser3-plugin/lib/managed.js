 ...
 */
class Managed extends _states.default {
  constructor(parent) {
    super(parent);
    this.useFrames = false;
    this.timeScale = 1;
    this.elapsed = undefined; // Badly named. This is "does it want to be paused, especially on startup", not "is this on the pending list", since the actual states around play/pause can be complex.
