...
var _emptyIter = _interopRequireDefault(require("./emptyIter"));
...
class Table extends Set {
  ...
  [DeleteLine](primary, pkey, secondary, cb = undefined) {
    ...
    for (let cell of line.values()) {
      if (cb) {
        cb.call(undefined, ...[...cell].reverse());
      }
