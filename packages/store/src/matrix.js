...
export default class Matrix {
    ...
    *values() {
    ...
    inc(u, v, increment=1, initial=0) { this.store.rmw(d=>increment+(d||initial), u, v) }
    /** Assuming numerical values; returns the or'd pattern. */
    bitwiseOr(u, v, pattern, initial=0) { this.store.rmw(d=>pattern|(d||initial), u, v) }
    ...
    setAdd(u, v, datum, setClass=Set) { this.store.rmw(d=>(d||new setClass()).add(datum), u, v); }
