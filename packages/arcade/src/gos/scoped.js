export default function scoped(clazz) {
    if (clazz.animationName) { return clazz }
    return class extends clazz {
        ...
        get prefix() { return undefined }
        // The default infix/animation for this type.
        get infix() { return undefined }
        get suffix() { return undefined }
