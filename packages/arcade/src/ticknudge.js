...
export default function ticknudge(sprite, x, y, still=.01, nudge=.001) {
    if (x == 0 && y == 0) { return }
    sprite.body.x += x;
    sprite.body.y += y;
    sprite.body.updateCenter();

    // Collision enforcement: Give it a *drop* of movement in this direction so that collision can occur if it's driven by tread.
