...
class Scene extends Phaser.Scene {
  ...
  create() {
    ...
    _tsp.default.create(this);

    this._createCursorKeys(); // /shrug.
  ...
  _createCursorKeys() {
    ...
    this[D] = new Map().set(this[A].left, Phaser.Math.Vector2.LEFT).set(this[A].right, Phaser.Math.Vector2.RIGHT).set(this[A].up, Phaser.Math.Vector2.UP).set(this[A].down, Phaser.Math.Vector2.DOWN);
    return this[A];
  }
